                        ...
                        <div className="BackModalBox" onClick={closeModal}>
                            <div className="ModalBoxDetail" onClick={(e) => e.stopPropagation()}>
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석1.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석2.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석3.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석4.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석5.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석6.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석7.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석8.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석9.png" />
                                ...
                                <div className="font-extrabold pb-2.5 pt-3 text-xl">
                                    <img className="inline-block" src="/강화석사진/강화석10.png" />
